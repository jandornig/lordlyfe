  ...
  return (
    <div className="flex justify-between items-center bg-gray-800 rounded-md p-4 text-sm gap-4">
      <div className="grid grid-cols-2 gap-x-6 gap-y-1">
        <div className="text-player font-semibold">{gameState.player1Name} Army:</div>
        <div className="text-right">{myArmy}</div>
        
        <div className="text-player font-semibold">{gameState.player1Name} Territory:</div>
      ...
      <div className="grid grid-cols-2 gap-x-6 gap-y-1">
        <div className="text-opponent font-semibold">{gameState.player2Name} Army:</div>
        <div className="text-right">{opponentArmy}</div>
        
        <div className="text-opponent font-semibold">{gameState.player2Name} Territory:</div>
